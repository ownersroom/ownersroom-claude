...
A focused install for **investors** — track your portfolio, view holdings and vesting, read news from companies you've invested in. ~13 tools. Smaller token footprint than the full `ownersroom-all` plugin (~78 tools).
