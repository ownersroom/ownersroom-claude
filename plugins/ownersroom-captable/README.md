...
A focused install for **company admins** — manage your company's capital structure: share classes, share issuances, option pools, grants, vesting, employee loans, contacts (people, companies), deals (primary share offerings), and company communications. ~60 tools.
