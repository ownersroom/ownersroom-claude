...
The full OwnersRoom surface in one install: cap table, options, employee equity, portfolio, fund management, and news. **64 MCP tools + 25 read-only Resources, all skills, all slash commands.**
